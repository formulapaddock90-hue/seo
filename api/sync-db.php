...
// File da sincronizzare - prova percorsi diversi
$file_paths = [
    '/web/htdocs/www.formulapaddock.it/seo/data/session-results.txt',      // Senza /home/
    '/www.formulapaddock.it/seo/data/session-results.txt',                  // Path relativo
    '/home/seo/data/session-results.txt',                                   // Solo home/seo
    __DIR__ . '/../data/session-results.txt'                                // Relativo
];
