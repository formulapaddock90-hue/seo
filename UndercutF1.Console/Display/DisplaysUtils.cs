...
public static class DisplayUtils
{
    ...
    public static readonly Style STYLE_HIGHLIGHT = new(
        foreground: Color.Black,
        background: Color.Yellow
    );
    public static readonly Style STYLE_ACCENT = new(
        foreground: Color.Cyan1
    );
    public static readonly Style STYLE_SUCCESS = new(
        foreground: Color.Green
    );
    public static readonly Style STYLE_WARNING = new(
        foreground: Color.Red
    );
    public static readonly Style STYLE_INFO = new(
        foreground: Color.SteelBlue1
    );
