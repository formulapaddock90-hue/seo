...
) : IDisplay
{
    ...
    public Task<IRenderable> GetContentAsync()
    {
        ...
        var tyreCompoundLegend = GetTyreCompoundLegend();

        var layout = new Layout("Root").SplitRows(
            new Layout("Tyre Stint Strategy", pitStintList),
            new Layout("Footer")
                .SplitColumns(
                    new Layout("Tyre Legend", tyreCompoundLegend).Size(20),
                    new Layout("Status", common.GetStatusPanel()).Size(15),
    ...
    private IRenderable GetTyreCompoundLegend()
    {
        var items = new List<IRenderable>
        {
            new Text("Tyre Compounds", Style.Parse("bold")),
            new Markup("[white on grey]H[/] Hard"),
            new Markup("[black on yellow]M[/] Medium"),
            new Markup("[white on red]S[/] Soft"),
            new Markup("[black on green]I[/] Intermediate"),
            new Markup("[black on blue]W[/] Wet"),
        };
