...
$redirect = safeRedirect((string) ($_GET['redirect'] ?? $_POST['redirect'] ?? ''));
$result = handleLogin();
...
<head>
    ...
    <style>
        ...
        .login-box button { width:100%; margin-top:1.2rem; padding:.65rem; background:#e10600; border:0; border-radius:4px; color:#fff; font-size:1rem; cursor:pointer; }
...
<div class="login-box">
    ...
    <form method="post" autocomplete="on">
        ...
        <label>Utente<input type="text" name="username" autocomplete="username" required autofocus></label>
