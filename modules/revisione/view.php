<section id="mod-g" class="tab-content">
    ...
    <form id="publish-form">
        ...
        <div id="g-panel-pubblica">
            <!-- Riga 1: Tipo, Stato, Categoria -->
            <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:10px;margin-bottom:10px;">
                <label style="margin:0;font-size:.85rem;">Tipo contenuto
                    <select name="post_type" id="wp-post-type" style="margin-top:4px;width:100%;box-sizing:border-box;">
                        <option value="post">Articolo (post)</option>
                        <option value="page">Pagina</option>
                    </select>
                </label>
                <label style="margin:0;font-size:.85rem;">Stato
                    <select name="publish_status" id="wp-status" style="margin-top:4px;width:100%;box-sizing:border-box;">
                ...
                <label id="wp-category-wrapper" style="margin:0;font-size:.85rem;">Categoria
                    <select name="category_name" id="wp-category-name" style="margin-top:4px;width:100%;box-sizing:border-box;">
                        <option value="">— categoria —</option>
                    </select>
                </label>
            </div>

            <!-- Riga 2: Pagina Genitore e Nuova Categoria -->
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-bottom:12px;">
                <label id="wp-parent-wrapper" style="margin:0;font-size:.85rem;">Pagina genitore
                    <select name="parent_page_id" id="wp-parent-page" style="margin-top:4px;width:100%;box-sizing:border-box;">
                        <option value="">Nessuna</option>
                    </select>
                </label>
                <label style="margin:0;font-size:.85rem;">Crea nuova categoria
                    <div style="display:flex;gap:6px;margin-top:4px;">
                        <input type="text" id="new-category-name" placeholder="Nuova categoria…" style="margin:0;flex:1;height:36px;box-sizing:border-box;">
                        <button type="button" id="add-category-btn" style="height:36px;white-space:nowrap;padding:0 12px;">+ Cat</button>
                    </div>
                </label>
            </div>
            ...
            <div style="display:flex;gap:10px;margin-top:6px;">
                <button type="button" id="review-publish" style="padding:8px 18px;">📤 Pubblica</button>
                <button type="button" id="review-edit" style="padding:8px 18px;">✏️ Modifica</button>
            </div>
        </div>
        ...
        <div id="g-panel-aggiorna" style="display:none;">
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:10px;margin-bottom:10px;">
                <label style="margin:0;font-size:.85rem;">Tipo contenuto
                    <select id="wp-update-post-type" style="margin-top:4px;width:100%;box-sizing:border-box;">
                        <option value="post">Articolo (post)</option>
                        <option value="page">Pagina</option>
                    </select>
                </label>
                <label style="margin:0;font-size:.85rem;">Stato
                    <select id="wp-update-status" style="margin-top:4px;width:100%;box-sizing:border-box;">
                        <option value="publish">Pubblica</option>
                        <option value="draft">Bozza</option>
                        <option value="pending">In revisione</option>
                    </select>
                ...
                <label id="wp-update-category-wrapper" style="margin:0;font-size:.85rem;">Categoria
                    <select id="wp-update-category-name" style="margin-top:4px;width:100%;box-sizing:border-box;">
                        <option value="">— categoria —</option>
                    </select>
                </label>
            </div>

            <!-- Riga 2: Pagina Genitore e Data Pubblicazione -->
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-bottom:10px;">
                <label id="wp-update-parent-wrapper" style="margin:0;font-size:.85rem;">Pagina genitore
                    <select id="wp-update-parent-page" style="margin-top:4px;width:100%;box-sizing:border-box;">
                        <option value="">Nessuna</option>
                    </select>
                </label>
                <label style="margin:0;font-size:.85rem;">Data pubblicazione
                    <input type="datetime-local" id="wp-update-date" style="margin-top:4px;width:100%;height:36px;box-sizing:border-box;">
                </label>
            </div>

            <!-- Riga 3: URL articolo da sovrascrivere -->
            <div style="margin-bottom:10px;">
                <label style="margin:0;font-size:.85rem;">URL articolo da sovrascrivere
                    <div style="display:flex;gap:6px;margin-top:4px;">
                        <input type="url" id="existing-article-url" placeholder="https://www.formulapaddock.it/…" style="flex:1;margin:0;height:36px;box-sizing:border-box;">
                        <button type="button" id="browse-sitemap-btn" style="white-space:nowrap;height:36px;padding:0 12px;">🗺️ Sfoglia</button>
                    </div>
                </label>
            </div>
            ...
            <div style="display:flex;gap:10px;">
                <button type="button" id="review-update" style="background:#1a2a4a;border-color:#3a5a9a;color:#8ab4f8;padding:8px 18px;">🔄 Aggiorna</button>
                <button type="button" id="review-edit-from-update" style="padding:8px 18px;">✏️ Modifica</button>
            </div>
        </div>
    </form>
