...
public static class TimingDataPointExtensions
{
    ...
    public static decimal? GapToLeaderSeconds(this TimingDataPoint.Driver driver)
    {
        ...
        return decimal.TryParse(driver.GapToLeader, NumberStyles.Any, CultureInfo.InvariantCulture, out var seconds) ? seconds : null;
    }
    ...
    public static decimal? IntervalSeconds(this TimingDataPoint.Driver.Interval interval)
    {
        ...
        return decimal.TryParse(interval?.Value, NumberStyles.Any, CultureInfo.InvariantCulture, out var seconds) ? seconds : null;
    }
